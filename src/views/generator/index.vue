  ...
  <div class="app-container">
    ...
    <div class="content-container">
      <el-table
        ...
        <el-table-column :show-overflow-tooltip="true" label="操作" width="160px" align="center" fixed="right">
          <template slot-scope="scope">
            <el-button size="mini" style="margin-right: 2px" type="text">
              <router-link :to="'/preview/' + scope.row.tableName">
                预览
              </router-link>
            </el-button>
            <el-button
...
export default {
  name: 'GeneratorIndex',
  components: { pagination, crudOperation, rrOperation, eConfig },
